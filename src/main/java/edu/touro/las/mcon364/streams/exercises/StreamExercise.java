...
public class StreamExercise {
    ...
    public List<String> getAllStudentNames() {
        ...
        return gradebook.keySet().stream().sorted().collect(Collectors.toList());
    }
    ...
    public long countStudents() {
        // TODO: Implement using streams
        return gradebook.values().stream().count();
    }
    ...
    public List<Integer> getStudentGrades(String studentName) {
        ...
        return Optional.ofNullable(gradebook.get(studentName)).stream()
                .flatMap(List :: stream).collect(Collectors.toList());// Replace with your implementation
    }
    // =========================================================================
    ...
    public double calculateAverage(String studentName) {
        ...
        return Optional.ofNullable(gradebook.get(studentName)).orElse(List.of(0)).stream().mapToInt(n -> n).average().getAsDouble();
    }
    ...
    public List<Integer> getAllGradesFlattened() {
        ...
        return gradebook.values().stream().flatMap(List::stream).sorted().collect(Collectors.toList());
    }
    ...
    public int findHighestGrade() {
        ...
        return gradebook.values().stream().flatMap(List::stream).max(Comparator.naturalOrder()).get();
    }
    ...
    public int findLowestGrade() {
        // TODO: Implement using streams
        return gradebook.values().stream().flatMap(List::stream).min(Comparator.naturalOrder()).get();
    }
    ...
    public long getTotalGradeCount() {
        ...
        return gradebook.values().stream().flatMap(List::stream).count();
    }
    ...
    public List<String> getPassingStudents(double threshold) {
        ...
        return gradebook.keySet().stream().filter (i -> calculateAverage(i) >= threshold).collect(Collectors.toList());
    }
    ...
    public Map<String, List<String>> groupByPerformance() {
        ...
        return gradebook.keySet().stream().collect(Collectors.groupingBy(p -> {
            return switch ((int) calculateAverage(p) / 10) {
                case 10, 9 -> "A";
                case 8 -> "B";
                case 7 -> "C";
                case 6 -> "D";
    ...
    public Map<String, Double> getStudentAverages() {
        ...
        return gradebook.keySet().stream().collect(Collectors.toMap(i -> i, i -> calculateAverage(i)));
    }
    ...
    public String findTopPerformer() {
        ...
        return gradebook.keySet().stream().max(Comparator.comparingInt(n->(int)calculateAverage(n))).get();
    }
